...
from .views import dashboard_of_dashboard, demo_login, demo_logout, demo_carlist_dashboard, dashboard_customer_list, demo_api, update_customer_status
...
urlpatterns = [
    ...
    path('dashboard/customer/status/<int:customer_id>/', update_customer_status, name='update_customer_status'),
